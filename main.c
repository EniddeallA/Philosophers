...
/*   Updated: 2021/11/14 07:46:43 by akhalid          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void philosophers(t_philo *philo, t_args args)
{
    ...
    {
        pthread_create(philo[i].philo, NULL, &routine, philo);
        i++;
    }
}
...
int main(int argc, char **argv)
{
    ...
    args.fork = (pthread_mutex_t *)malloc(sizeof(pthread_mutex_t) * args.n_philo);
